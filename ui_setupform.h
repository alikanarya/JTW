...
public:
    ...
    void setupUi(QWidget *setupForm)
    {
        ...
        checkSubImage->setGeometry(QRect(1040, 720, 101, 17));
        ...
        editHoughThetaMinSub->setGeometry(QRect(1040, 740, 42, 20));
        ...
        editHoughThetaStepSub->setGeometry(QRect(1140, 740, 42, 20));
        ...
        editHoughThetaMaxSub->setGeometry(QRect(1090, 740, 42, 20));
        editHoughThetaMaxSub->setAlignment(Qt::AlignCenter);
        line_2 = new QFrame(setupForm);
        line_2->setObjectName(QStringLiteral("line_2"));
        line_2->setGeometry(QRect(1011, 580, 320, 16));
        ...
        label_15->setGeometry(QRect(410, 420, 231, 101));
        ...
        readMachineStatusBox->setGeometry(QRect(420, 450, 211, 17));
        ...
        readDistanceBox->setGeometry(QRect(420, 470, 201, 17));
        ...
        readWeldSeamBox->setGeometry(QRect(420, 490, 201, 17));
