...
public:
    ...
    void setupUi(QWidget *setupForm)
    {
        ...
        label_7->setGeometry(QRect(1110, 730, 111, 20));
        ...
        editHoughThreshold->setGeometry(QRect(1230, 728, 42, 20));
        ...
        labelVoteAvg->setGeometry(QRect(1280, 728, 42, 20));
        ...
        plainTextEdit->setGeometry(QRect(20, 540, 580, 196));
        QFont font2;
        ...
        editVoidThreshold->setGeometry(QRect(1230, 698, 42, 20));
        editVoidThreshold->setAlignment(Qt::AlignCenter);
        label_10 = new QLabel(setupForm);
        label_10->setObjectName(QStringLiteral("label_10"));
        label_10->setGeometry(QRect(1110, 700, 111, 20));
        ...
        saveExitButton->setGeometry(QRect(1540, 720, 121, 25));
        ...
        checkSubImage->setGeometry(QRect(1540, 670, 101, 17));
        ...
        editHoughThetaMinSub->setGeometry(QRect(1530, 690, 42, 20));
        ...
        editHoughThetaStepSub->setGeometry(QRect(1630, 690, 42, 20));
        ...
        editHoughThetaMaxSub->setGeometry(QRect(1580, 690, 42, 20));
