...
typedef unsigned char  PlcBYTE; // 1byte
typedef unsigned short PlcWORD; // 2bytes
typedef unsigned long  PlcDWORD; //4bytes
...
public:
    ...
    int protocol = 0;
    int socketWaitForConnectedTime = 500;   //msecond
    int loopSleepTime = 1000;               //msecond
    int disconnectSleepTime = 1000;         //msecond
