...
//---------------
        ...
        if (subImageProcessingSwitch && iprocess->detected) {
            ...
            iprocessLeft->detectVoidLines();                            // detect void lines on hough lines in mono image
            ...
            iprocessRight->detectVoidLines();                           // detect void lines on hough lines in mono image
